...
export default function Service_Dashboard() {
  return (
    <div className='flex  justify-center items-center flex-col mt-24 md:px-28 sm:px-16 px-5 lg:px-40 space-y-5'>
      ...
      <div className='flex flex-col justify-center items-center space-y-2'>
        ...
        <p class='first-line-indent' className='font-sans text-justify'>
      ...
      <div className='flex justify-center items-center'>
        <div
          className='flex items-center justify-center rounded-2xl shadow-md shadow-green bg-green w-40 p-2 text-TextColor
        hover:bg-SButton'
        >
